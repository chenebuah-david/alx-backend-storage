...
"""The Module declares a redis class and methods"""
import redis
...
def count_calls(method: Callable) -> Callable:
    ...
    def wrapper(self, *args, **kwargs):
        '''Enclose the decorated function and return the wrapper'''
...
def call_history(method: Callable) -> Callable:
    ...
    @wraps(method)
    def wrapper(self, *args, **kwargs):
        '''Enclose the decorated function and return the encloser'''
        input = str(args)
